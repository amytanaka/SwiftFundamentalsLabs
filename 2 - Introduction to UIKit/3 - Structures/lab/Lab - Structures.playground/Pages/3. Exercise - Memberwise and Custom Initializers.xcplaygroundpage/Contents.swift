 ...
 */
print("\n\"Memberwise and Custom Initializers\" [3 of 10]")
print("----------------------------------------------")
...
let favoriteBook = Book(title: "Kafka on the Shore", author: "Haruki Murakami", pages: 100, price: 10.99)
...
struct Height {
    ...
    init(heightInInches: Double) {      // for passing in a height in inches
        self.heightInInches = heightInInches
        heightInCentimeters = heightInInches * 2.54
    }
    
    init(heightInCentimeters: Double) {         // for passing in a height in cm
 ...
 */
var myHeight = Height(heightInCentimeters: 154)
