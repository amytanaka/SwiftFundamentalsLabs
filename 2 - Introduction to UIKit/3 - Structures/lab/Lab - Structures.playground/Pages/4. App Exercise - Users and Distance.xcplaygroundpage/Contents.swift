 ...
 */
var amy = User(name: "Amy", age: 24, height: 60, weight: 102, activityLevel: 5)
print("User \"\(amy.name)\" is \(amy.age) years old, \(amy.height)\" tall, and weighs \(amy.weight) lbs. Their activity level is \(amy.activityLevel)\\10.")
/*:
...
print("Distance in ft: \(mile.feet)")
/*:
 Now create another instance of `Distance` and give it some other distance. Ensure that both properties are set correctly.
 */
var toSchool = Distance(feet: 3000)
print("Distance to school in meters: \(toSchool.meters)")
print("Distance to school in feet: \(toSchool.feet)")
