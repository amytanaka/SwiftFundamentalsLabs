 ...
 */
print("\n\"Computed Properties and Property Observers\" [7 of 10]")
print("----------------------------------------------")
...
var newRectangle = Rectangle(width: 5, height: 7)
    ...
    var heightInInches: Double {
        didSet {
            if heightInCentimeters != (heightInInches * 2.54) {
                ...
                // print("New height in cm: \(heightInCentimeters)")
            }
        }
    }
    ...
    var heightInCentimeters: Double {
        didSet {
            if heightInInches != (heightInCentimeters / 2.54) {
                ...
                // print("New height in inches: \(heightInInches)")
            }
        }
    }
...
myHeight.heightInCentimeters = 154
