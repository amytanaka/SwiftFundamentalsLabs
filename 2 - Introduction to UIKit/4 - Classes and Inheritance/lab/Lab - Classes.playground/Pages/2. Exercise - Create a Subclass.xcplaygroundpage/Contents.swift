...
print("Position of \(destroyer.name): \(destroyer.position)")
destroyer.moveRight()
print("Position of \(destroyer.name): \(destroyer.position)")
/*:
 ...
 */
// print(falcon.weapon)
// falcon is an instance of a  base class so it does not have the properties of the Fighter subclass
/*:
 ...
 */
destroyer.fire()
print("Remaining fire power of \(destroyer.name): \(destroyer.remainingFirePower)")
destroyer.fire()
print("Remaining fire power of \(destroyer.name): \(destroyer.remainingFirePower)")
destroyer.fire()
print("Remaining fire power of \(destroyer.name): \(destroyer.remainingFirePower)")
