...
*/
print("\n\"Override Methods and Properties\" [3 of 4]")
print("----------------------------------------------")
...
defender.moveRight() // position = 0 + 1
print("Position of \(defender.name): \(defender.position)")
defender.fire() // remaining fire power = 5 - 1
 ...
 */
defender.wasHit() // health = 25 - 5
print("Shield Strength of \(defender.name): \(defender.shieldStrength)")
