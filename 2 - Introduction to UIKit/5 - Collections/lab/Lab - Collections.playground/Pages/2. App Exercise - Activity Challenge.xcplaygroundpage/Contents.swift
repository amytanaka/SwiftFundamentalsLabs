 ...
 */
print("\n\"Activity Challenge\" [2 of 4]")
print("----------------------------------------------")

var walkingChallenges: [String] = ["Walk 3 miles a day", "Walk 5 times a week"]
var runningChallenges: [String] = ["Run 1 mile a day", "Run 10 miles a week"]
 ...
 */
var challenges: [Array] = [walkingChallenges, runningChallenges]
 ...
 */
var currentChallenges: [String] = ["Run 1 mile a day"]
/*:
 Write an if statement that will use `isEmpty` to check if there is anything in the array. If there is not, print a statement asking the user to commit to a challenge. Add an else-if statement that will print "The challenge you have chosen is <INSERT CHOSEN CHALLENGE>" if the array count is exactly 1. Then add an else statement that will print "You have chosen multiple challenges."
 */
if currentChallenges.isEmpty {
    print("Please commit to a new challenge.")
} else if currentChallenges.count == 1 {
    print("The challenge you have chosen is \(currentChallenges[0])")
} else {
